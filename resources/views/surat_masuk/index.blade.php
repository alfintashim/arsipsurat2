    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
                ...
                <div class="card-tools"><button type="button" class="btn btn-block btn-outline-success btn-sm" data-toggle="modal" data-target="#create-sm">
                ...
                <tbody>
                    @foreach ($tsm as $item)
                        <tr>
                            ...
                            <td align="center">
                                <a href="{{ url('tsm/'.$item->id) }}" class="btn bg-gradient-info btn-xs" title="Detail">
...
<form role="form" method="POST" action="{{ route('tsm.store') }}" enctype="multipart/form-data">
    @csrf
<div class="modal fade" id="create-sm">
            ...
            <div class="card card-primary">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter asal surat" name="asal" value="{{ old('asal') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="tgl_diterima" value="{{ old('tgl_diterima') }}" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask>
                            </div>
                        </div>
                        <div class="form-group">
