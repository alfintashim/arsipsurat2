            ...
            <div class="card">
                <div class="card-body">
                    <div class="row input-daterange">
                        <form role="form" action="{{ route('lsm.download') }}" method="get">
                            <div class="row">
                                <div class="col-sm-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="suratmasuks_table">
                            <thead>
                            <tr align="center">
                                <th>Perihal</th>
                                <th>Asal Surat</th>
...
$(document).ready(function(){
 ...
 $('#filter').click(function(){
  ...
  {
   $('#suratmasuks_table').DataTable().destroy();
